...
class FlywayMigrationIT {
    ...
    void expectedTablesExist() throws Exception {
        Set<String> expectedTables = Set.of(
                ...
                "customers", "vehicles",
                "suppliers", "products",
                "quotes", "quote_items", "work_orders", "work_order_items", "appointments", "inspections", "inspection_items", "inventory_movements",
    ...
    void rowLevelSecurityIsEnabledOnTenantTables() throws Exception {
        String[] rlsTables = {"tenants", "units", "users", "work_orders", "work_order_items", "quotes", "quote_items", "customers", "appointments", "inspections", "inspection_items", "inventory_movements"};
